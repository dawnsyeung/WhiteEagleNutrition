...
- The default `npm run build` is a no-op because this is a static site.
- Run `npm run build:schema` before deploy to refresh homepage/products/about/contact JSON-LD, product detail pages, and sitemap data.
